...
function CaseSection() {
    ...
    return (
        <section id="use-cases" className="mt-16 mb-8" aria-labelledby="use-cases-heading" data-aos="fade-up">
            <h2 id="use-cases-heading" className="text-3xl font-bold mb-6" data-aos="fade-down">
                이렇게 사용해보세요 | Use Cases
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <article className="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="100">
                ...
                <article className="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="200">
                ...
                <article className="flex flex-col items-center" data-aos="zoom-in" data-aos-delay="300">
